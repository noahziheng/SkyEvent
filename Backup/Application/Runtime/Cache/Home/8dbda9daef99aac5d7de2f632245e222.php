       ...
       <div class="container">
          <div class="row">
             <div class="col-md-6">
                <!-- Logo -->
                <div class="logo">
                   <h1><a href="<?php echo (ROOT_URL); ?>Index/index" onclick="reindex();"><img src="<?php echo (ROOT_URL); ?>Public/images/logo.png"  style="width:auto;height:40px;"></a><a href="http://www.vatprc.net"><img src="http://www.vatprc.net/media/images/logo(2).png" style="width:130px;height:35px;"></a></h1>
                </div>
             </div>
             <div class="col-md-4">
				...
				<form class="form-horizontal">
					...
					<div class="form-group">
						...
						<ul class="nav nav-tabs" role="tablist">
							<li role="presentation"><a href="#zh-cn" aria-controls="zh-cn" role="tab" data-toggle="tab">简体中文(zh-cn)</a></li>
							<li role="presentation" class="active"><a href="#en-us" aria-controls="en-us" role="tab" data-toggle="tab">English(United States) (en-us)</a></li>
						</ul>
						</div>
						<div class="tab-content">
							<div role="tabpanel" class="tab-pane" id="zh-cn">
								<div class="form-group">
									<label for="post_title" class="col-sm-2 control-label"><?php echo (L("post_title")); ?></label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="post_title_cn" value="<?php if($type == 1): echo ($event["title"]["zh-cn"]); endif; ?>" autofocus>
									</div>
								</div>
								<div class="form-group">
									<label for="ckeditor_standard" class="col-sm-2 control-label"><?php echo (L("post_detail")); ?></label>
									<div class="col-sm-10">
										<textarea id="ckeditor_standard_cn"><?php if($type == 1): echo ($event["detail"]["zh-cn"]); endif; ?></textarea>
									</div>
								</div>
							</div>
							<div role="tabpanel" class="tab-pane active" id="en-us">
								<div class="form-group">
									<label for="post_title" class="col-sm-2 control-label"><?php echo (L("post_title")); ?></label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="post_title_en" value="<?php if($type == 1): echo ($event["title"]["en-us"]); endif; ?>" autofocus>
									</div>
								</div>
								<div class="form-group">
									<label for="ckeditor_standard" class="col-sm-2 control-label"><?php echo (L("post_detail")); ?></label>
									<div class="col-sm-10">
										<textarea id="ckeditor_standard_en"><?php if($type == 1): echo ($event["detail"]["en-us"]); endif; ?></textarea>
									</div>
								</div>
							</div>
						</div>
