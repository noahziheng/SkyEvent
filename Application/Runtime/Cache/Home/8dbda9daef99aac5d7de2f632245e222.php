      ...
      <div class="col-md-2">
             <div class="panel panel-default">
              ...
              <div class="panel-body">
                <a href="<?php echo (SSO_URL); ?>" class="btn btn-primary btn-lg btn-block"><img class="img-responsive" src="<?php echo (ROOT_URL); ?>Public/images/vatsim.png">SSO <?php echo (L("login")); ?></a>
              </div>
            </div>
