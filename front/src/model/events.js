export default {
  getAll: function () {
    return [
      {
        id: 4,
        title: '2015年 北京区调 获得VATSIM官方金麦奖',
        description: '在过去的一年中，VATPRC分部北京区调以2430h58min的在线时间（27.8%的上线率），获得了VATSIM Golden Mic Award！这也是VATSIM中国分部首次获得如此高的奖项。',
        image: 'http://ironmic.vatsim.net/2015/2015_ctr_gold.png'
      },
      {
        id: 3,
